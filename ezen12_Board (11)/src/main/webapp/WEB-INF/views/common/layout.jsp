...
<body>
	<div id="container">
		...
		<div id="sidebar-left">
			<!-- tiles_member.xml의 definition의 하위 태그 put-attribute 태그의 name이 side인 JSP를 표시함 -->
		...
		<div id="footer">
			<!-- tiles_member.xml의 definition의 하위 태그 put-attribute 태그의 name이 footer인 JSP를 표시함 -->
