...
public class BoardControllerImpl implements BoardController {
	...
	@ResponseBody
	public ResponseEntity removeArticle(@RequestParam("articleNO") int articleNO, 		//삭제할 글번호 가져옴
											HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		...
		try {
			boardService.removeArticle(articleNO);			//글번호 전달해서 글 삭제함
