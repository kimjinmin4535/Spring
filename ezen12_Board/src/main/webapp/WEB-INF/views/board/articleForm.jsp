...
<head>
	...
	<script type="text/javascript">
		...
		function fn_addFile() {
			...
			innerHtml += '<div width=100% align=center>'
...
<body>
	...
	<form name="ariticleForm" method="post" action="${contextPath}/board/addNewArticle.do"
		enctype="multipart/form-data">  <!-- 파일 업로드 가능 -->
		<table border="0" align="center">
			...
			<tr>
				...
				<td><img id="preview0" alt="이미지" src="#" width="440px" height="280px"></td>  <!-- 첨부이미지 미리보기 -->
			</tr>
			<tr>
				<td colspan="3">
